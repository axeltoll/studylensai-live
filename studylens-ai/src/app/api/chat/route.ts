...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = {
        role: 'system',
        content: 'You are StudyLens AI, a helpful and encouraging AI tutor. Assist the student with their questions clearly and concisely. Focus on educational value.'
    };
